...
module.exports = {    
     ...
     */
    assets: {
        css: [__dirname + "/wi.core.panelsbar.style.css"],
        js: [__dirname + "/wi.core.panelsbar.events.js"]
    },
    ...
    getTemplate: function(_this){
        return TemplateEngine(__dirname + "/wi.core.panelsbar.tpl.ejs").seti18n(_this.i18n).render({itens: this.itens});
    }
};